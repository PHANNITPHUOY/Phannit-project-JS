let dog_product = [
    {img:"../images/3.png", name:"Chicaco", price:"$10"},
    {img:"../images/3.png", name:"Fruit lover", price:"$10"},
    {img:"../images/3.png", name:"Hot & spicy veg", price:"$10"},
    {img:"../images/3.png", name:"Ham", price:"$10"},
    {img:"../images/3.png", name:"Greek", price:"$10"},
    {img:"../images/3.png", name:" Cheeses", price:"$10"},
    {img:"../images/3.png", name:"Hawaiian", price:"$10"},
    {img:"../images/3.png", name:" Vegetariana", price:"$10"},
    {img:"../images/3.png", name:" Sicilian", price:"$10"},
    {img:"../images/3.png", name:"BBQ Chicken", price:"$10"},
    {img:"../images/3.png", name:" Meat ", price:"$10"},
    {img:"../images/3.png", name:"California", price:"$10"},
    {img:"../images/3.png", name:"Popperani", price:"$10"},
    {img:"../images/3.png", name:"Detroit", price:"$10"},
    {img:"../images/3.png", name:"Margherota", price:"$10"},
    {img:"../images/3.png", name:"Chinese", price:"$10"},
