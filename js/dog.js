let dog_product = [
    {img:"../images/2.png", name:"Chicaco", price:"$10"},
    {img:"../images/2.png", name:"Fruit lover", price:"$10"},
    {img:"../images/2.png", name:"Hot & spicy veg", price:"$10"},
    {img:"../images/2.png", name:"Ham", price:"$10"},
    {img:"../images/2.png", name:"Greek", price:"$10"},
    {img:"../images/2.png", name:" Cheeses", price:"$10"},
    {img:"../images/2.png", name:"Hawaiian", price:"$10"},
    {img:"../images/2.png", name:" Vegetariana", price:"$10"},
    {img:"../images/2.png", name:" Sicilian", price:"$10"},
    {img:"../images/2.png", name:"BBQ Chicken", price:"$10"},
    {img:"../images/2.png", name:" Meat ", price:"$10"},
    {img:"../images/2.png", name:"California", price:"$10"},
    {img:"../images/2.png", name:"Popperani", price:"$10"},
    {img:"../images/2.png", name:"Detroit", price:"$10"},
    {img:"../images/2.png", name:"Margherota", price:"$10"},
    {img:"../images/2.png", name:"Chinese", price:"$10"},
